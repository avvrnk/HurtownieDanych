...
create table Data(
    IdDaty integer identity(1,1) primary key, 
...
create table Hotel(
    IdHotelu integer identity(1,1) primary key, 
...
create table Pilot(
    IdPilota integer identity(1,1) primary key, 
...
create table Wycieczka(
    IdWycieczki integer identity(1,1) primary key, 
...
create table Atrakcja(
    IdAtrakcji integer identity(1,1) primary key, 
    Nazwa varchar(100) not null, 
...
create table Oferta(
    IdOferty integer identity(1,1) primary key, 
